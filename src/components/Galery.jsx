function MasonryGridGallery() {
	return (
		<div>
			<h1 className="text-center text-3xl font-bold text-blue-600 mt-10">GALERI GAMBAR</h1>
			<div className="grid grid-cols-2 gap-4 md:grid-cols-4 container mx-auto my-20">
